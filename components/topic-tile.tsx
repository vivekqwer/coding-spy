...
export function TopicTile({ topic, index }: { topic: TopicCardData; index: number }) {
  ...
  return (
    ...
    >
      <Link
        href={lessonHref}
        className="flex h-full items-center justify-center rounded-xl px-4 py-6 text-center font-semibold transition hover:-translate-y-0.5 hover:brightness-110"
